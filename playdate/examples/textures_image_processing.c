...
int main(void)
{
    ...
    ImageResize(&imOrigin, 200, 150);      // Playdate: fit next to the process list
    ...
    for (int i = 0; i < NUM_PROCESSES; i++) toggleRecs[i] = (Rectangle){ 10.0f, (float)(45 + 22*i), 115.0f, 20.0f };
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            DrawTexture(texture, screenWidth - texture.width - 40, screenHeight/2 - texture.height/2, WHITE);
