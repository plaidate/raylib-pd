...
#include "raylib.h"
    ...
    #define PHYSAC_NO_THREADS           // Playdate: step physics manually in the game loop
    #define MOUSE_RIGHT_BUTTON MOUSE_MIDDLE_BUTTON      // Playdate: B button spawns circles
#endif
#define PHYSAC_IMPLEMENTATION
#include "physac.h"              // Playdate: vendored next to the example
...
#if defined(PLATFORM_PLAYDATE)
        RunPhysicsStep();               // Playdate: no physics thread
#endif
