...
tempor incididunt ut labore et dolore magna aliqua. Nec ullamcorper sit amet risus nullam eget felis eget.";
    ...
    Rectangle container = { 25.0f, 25.0f, screenWidth - 50.0f, screenHeight - 90.0f };
    ...
    const float maxHeight = screenHeight - 90.0f;
    ...
    while (!WindowShouldClose())        // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            // Draw bottom info
            DrawRectangle(0, screenHeight - 40, screenWidth, 40, GRAY);
            

            DrawText("Word Wrap: ", 313, screenHeight-115, 20, BLACK);
            if (wordWrap) DrawText("ON", 330, screenHeight - 55, 10, RED);
            else DrawText("OFF", 330, screenHeight - 55, 10, BLACK);

            DrawText("Press A to toggle word wrap:", 60, screenHeight - 55, 10, GRAY);

            DrawText("raylib DrawTextBoxed() on Playdate", 80, screenHeight - 28, 10, RAYWHITE);
